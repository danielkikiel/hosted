                        ...
                        <div class="invoice col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h1 class="m-b-md"><b>Potwierdź zamówienie</b></h1>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>Hosting www - opcja {hostingname}</td>
                                                        <td>1</td>
                                        ...
                                        <div class="col-md-12">
                                            <div class="text-right">
                                                ...
                                                <hr>
                                                <a href="servers.php?section=order&do=newOrder" class="btn btn-default">Anuluj</a> 
                                                <a href="servers.php?section=order&do=done&action=payments&plan={hostingname}" class="btn btn-primary">Przejdź dalej</a>
                                            </div>
                                        </div>
                                    </div><!--row-->
                                </div>

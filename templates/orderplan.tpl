                    ...
                    <div class="row">
                        <div class="invoice col-md-12">
                            <div class="panel-body">
                                    <h2>Szczegóły dotyczące zamówienia</h2><br /><br />
                                    <form action="servers.php?section=order&do=done&action=payments&plan={hostingname}" method="post">
                                        <div class="form-group">
                                            <label for="nameFTP">Podaj nazwe użytkownika FTP</label>
                                            <input type="input" name="userFTP" class="form-control" id="nameFTP" placeholder="Nazwa użykownika...">
                                        </div>
                                        <div class="form-group">
                                            <label for="domainFTP">Domena</label>
                                            <input type="input" name="domainFTP" class="form-control" id="domainFTP" placeholder="Domena np. domena.pl">
                                        </div>

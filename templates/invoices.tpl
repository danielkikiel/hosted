            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="invoices.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-edit"></span><p>Faktury</p></a></li>
            ...
            <div class="page-inner">
                <div class="page-title">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="invoices.php">Faktury</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <p>
                                                ...
                                                <strong>Żeby opłacić kupione usługi, przejdź do faktury.</strong>
                                            </p>
                                        </div>
                                        <div class="col-md-12">
                                            {invoices}
